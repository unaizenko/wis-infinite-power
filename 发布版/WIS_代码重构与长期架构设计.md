...
开发版与发布版均显示版本 `0.1.4.6`，并采用本地 `break_eternity.js`，由 `js/core/bignum.js` 统一适配，当前存档 Schema 为 47。J、战力、法力、仙灵力、累计资源、资源来源、费用、需求、量级阈值与软上限数值均使用 Decimal；JSON 存档将其写为字符串，旧 Number 存档继续兼容。
