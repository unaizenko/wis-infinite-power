(function defineTreasureMeta(WIS) {
  ...
  WIS.Meta.Treasures = Object.freeze({
    keys: Object.freeze(["tianNiPearl", "mysteriousGreenBottle", "fuBao", "fitnessMembershipCard", "superLollipop", "skyCrystal", "fiveSpiritStone", "xuTianDing", "baLingChi", "wanYaoFan", "phantomHeavenMirror", "mysticHeavenSacredTree", "mysticHeavenSpiritSlayingSword", "fiveElementsTreasure", "immortalCrystal"]),
    count(state, key) {
